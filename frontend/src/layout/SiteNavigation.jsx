...
const SiteNavigation = () => {
  ...
  const navItems = [
    ...
    { name: 'Bookmarked', href: '#bookmarks', icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path d="M5 4a2 2 0 012-2h6a2 2 0 012 2v14l-5-2.5L5 18V4z" /></svg> }  ];
    ...
    <>
      ...
      <div className="lg:hidden">
        ...
        {isOpen && (
          ...
          >
            <div className="flex flex-col h-full w-64 bg-white dark:bg-neutral-800" onClick={(e) => e.stopPropagation()}>
              {/* Logo */}
                ...
                {navItems.map((item, index) => (
                  <li key={item.name}>
                    <a 
                      ...
                      className={`flex items-center px-4 py-3 ${index === 0 ? 'text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/20 border-r-4 border-blue-600 dark:border-blue-400' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-neutral-700/30'} transition duration-150`}
                    >
